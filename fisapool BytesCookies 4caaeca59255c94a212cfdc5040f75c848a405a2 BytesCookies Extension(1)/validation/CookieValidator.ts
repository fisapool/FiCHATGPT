...
export class CookieValidator {
  ...
  private validateRequiredFields(cookie: Cookie, errors: ValidationErrorData[]): void {
  ...
  private validateDomain(domain: string, errors: ValidationErrorData[]): void {
  ...
  private validateFormat(cookie: Cookie, errors: ValidationErrorData[]): void {
    // Check domain format
